...
from core_algorithms.actor_model import LSTM_ACTOR, CONV_ACTOR
...
if __name__ == "__main__":
    ...
    parser.add_argument('--state_length', type=int, default=3)
    parser.add_argument('--seed', type=int,
                        default=SEED_RANGE[1], help='Random seed to be used')
    parser.add_argument('--start_steps', default=1000,
    ...
    parser.add_argument('--parents', default=5, type=int)
    parser.add_argument('--elitism', dest="elitism",  action='store_true')
    parser.add_argument('--n_grad', default=0, type=int)
    parser.add_argument('--sigma_init', default=0.3, type=float)
   ...
   # Training parameters:
    parser.add_argument('--n_evals', default=2, type=int)
    parser.add_argument('--n_generations', default=2, type=int)

    parser.add_argument('--max_iter', default=100, type=int)
    # parser.add_argument('--max_steps', default=100000, type=int)
    parser.add_argument('--sample_ratio', default=[0.8, 0.1, 0.1], type=list)
    parser.add_argument('--mem_size', default=200000000, type=int)
    parser.add_argument('--disable_cuda', action='store_true')
    parser.add_argument('--use_sac', action='store_true')
    parser.add_argument('--use_multiAgent', action='store_true')

    args = parser.parse_args()

    parameters = ESParameters(conf=args, init=True)
    run_name = "CEM_TD3Buffers_Conv2D_obsLength3_stateDim6_adaptSigmaV1_RLsync_100iters_deep3h32_new_covSaving_pop10_parents5"
    ...
    if args.should_log:
        ...
        run = wandb.init(
            project="Fault_tolerant_flight_control_CEMTD3Buffers",
